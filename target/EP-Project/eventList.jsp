...
<h1>Welcome to the University Event Management System</h1>
 ...
 <div class="sidenav">
        ...
        <table class="event-table">
            ...
            <%
                ...
                try {
                    ...
                    rs = stmt.executeQuery("SELECT event_id, event_name, event_date, organized_by, image_url FROM events");
                    ...
                    while (rs.next()) {
                        ...
                        String organizer = rs.getString("organized_by");
                        String imageUrl = rs.getString("image_url");
            %>
            <tr>
                <td>
                    <div class="event-container" style="background-image: url('<%= imageUrl%>');">
    ...
    <input type="submit" value="Register" class="register-button">
            ...
            %>
            <tr>
                <td colspan="2">No ongoing events available.</td>
            </tr>
            <%
                }
            %>
